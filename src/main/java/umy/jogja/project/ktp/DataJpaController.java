...
import umy.jogja.project.ktp.exceptions.NonexistentEntityException;
import umy.jogja.project.ktp.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("umy.jogja_project.ktp_jar_0.0.1-SNAPSHOTPU");
