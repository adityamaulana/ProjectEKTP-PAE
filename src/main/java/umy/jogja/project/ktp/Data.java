...
public class Data implements Serializable {
    ...
    public Data(Long id, String noktp, Date tgllahir, String jeniskelamin, String alamat, String agama, String status, String warganegara) {
        this.id = id;
        this.noktp = noktp;
    ...
    public String toString() {
        return "umy.jogja.project.ktp.Data[ id=" + id + " ]";
    }
